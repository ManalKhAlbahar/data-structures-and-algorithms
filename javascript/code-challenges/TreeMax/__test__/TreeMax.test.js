...
describe('BT testing', () => {
    ...
    beforeAll(() => {
        ...
        three.left = four;
        three.right = five;
        treeTest = new maxTree(one);
    });

    test('constructor', () => {
        const newTree = new maxTree();
    ...
    test('maxTree test', () => {
        expect(treeTest.maxTree()).toBe(7)
        let newTree = new maxTree();
        expect(newTree.maxTree()).toBe('Tree is Empty');
